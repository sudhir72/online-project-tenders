...
<!-- header begins -->
  ...
  <div id="menu">
		<ul>
			...
			<li id="button1"><a href="progr.html" title="">back</a></li>
			<li id="button2"><a href="../index3.html" title="">logout</a></li>
			<li id="button3"><a href="#" title="">About Us</a></li>
			<li id="button4"><a href="#" title="">Contact Us</a></li>
		</ul>
 </div>
